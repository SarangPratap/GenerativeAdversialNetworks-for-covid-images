...
#Prints the GPU Availabe for processing
...
def load_real_samples():
  location="E:\Development Projects\GAN"
...
def save_plot(examples, epoch, n=3):
  ...
  # save plot to file
  filename = 'generated_plot_m%03d.png' % (epoch+1)
...
def train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=1000, n_batch=20):
